...
@Retention(RUNTIME)
@Operation(
        summary = "Create a weapon (Admin)",
        description = "Creates a new weapon. The request body must contain valid weapon attributes.",
        requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                ...
                content = @Content(
                        ...
                        schema = @Schema(
                                ...
                                example = GameInformationExampleProvider.CREATE_WEAPON
                        )
                )
        )
)
public @interface CreateWeaponDocs { }